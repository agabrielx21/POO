...
public:
    ...
    void afisare2(){
        ...
        cin >> optiune;
        if(optiune == 1){
            cout << "Introduceti numele dupa care se va face cautarea (string) : ";
            string name;
            cin >> name;
            for(int i=0; i<statii.size(); i++){
            ...
            cout << "Introduceti strada dupa care se va face cautarea (string) : ";
            string street;
            cin >> street;
            for(int i=0; i<statii.size(); i++){
            ...
            cout << "Introduceti codul statiei (string) : ";
            string n;
            cin >> n;
            for(int i=0; i<statii.size(); i++){
    ...
    void afisareAutobuz(){
        cout << "Introduceti nr. traseului (int)";
        int n;
        cin >> n;
        for(int i=0; i<statii.size(); i++){
    ...
    void pret(){
        ...
        string s1,s2;
        cout << "Introduceti statia de plecare (string) :" ;
        cin >> s1;
        cout << "Introduceti statia de sosire (string) : ";
        cin >> s2;
        ...
        cout << "Pretul estimat este: " << pret << endl;
    }
};
